...
export default function Quiz() {
  ...
  return <div dir="rtl" className="quiz-page">
    <header className="quiz-topbar"><div className="container quiz-nav">
      <Link href="/" className="quiz-brand"><span className="quiz-brand-mark">ك</span><span>مؤسسة <b>الكتبية</b><small>لتعليم السياقة</small></span></Link>
      <nav><Link href="/">الرئيسية</Link><a className="is-active" href="#quizzes">الاختبارات</a><Link href="/page3.html">دليل الرخصة</Link><a href="#contact">تواصل معنا</a></nav>
      <Link href="/" className="quiz-home"><ArrowRight size={16} /> الرئيسية</Link>
    </div></header>
