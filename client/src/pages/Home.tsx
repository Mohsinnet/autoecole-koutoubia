  ...
  return (
    <div dir="rtl" className="site-shell">
      ...
      <main>
        ...
        <section className="video-section section-pad" aria-labelledby="video-title"><div className="container video-grid"><div className="video-copy"><div className="section-kicker"><span>01</span><div /><p>شاهد طريقة التكوين</p></div><h2 id="video-title">خطوتك الأولى<br /><span>تبدأ بفهم الطريق.</span></h2><p>تعرف على أجواء مؤسسة الكتبية وطريقتنا في مواكبة المتعلمين من أول حصة إلى يوم الامتحان.</p><div className="video-meta"><span><Play size={15} /> فيديو تعريفي</span><span><ShieldCheck size={15} /> تكوين آمن واحترافي</span></div><a href={whatsapp} target="_blank" rel="noreferrer" className="text-link">اسألنا عن التسجيل <ArrowLeft size={17} /></a></div><div className="video-frame"><iframe src="https://player.cloudinary.com/embed/?cloud_name=azp0ikkv&public_id=vid_auto_Ecolekoutoubia_pfobxy" title="فيديو تعريفي بمؤسسة الكتبية لتعليم السياقة" allow="autoplay; fullscreen; encrypted-media; picture-in-picture" allowFullScreen loading="lazy" /><span className="video-corner">01 / شاهد</span></div></div></section>\n\n        <section id="about" className="intro-section section-pad">
